...
// localStorage key for bulletin posts
export const BULLETIN_STORAGE_KEY = "hrpulse.bulletin.posts";

// Default posts (used when localStorage is empty)
export const DEFAULT_BULLETIN_POSTS: BulletinPost[] = [
  {
    id: "b1",
    titleTh: "ประกาศนโยบาย Work from Home ปี 2025",
    titleEn: "Work from Home Policy 2025",
    contentTh: "บริษัทขอประกาศนโยบาย Work from Home ใหม่สำหรับปี 2025 โดยพนักงานสามารถทำงานจากที่บ้านได้สัปดาห์ละ 2 วัน โดยต้องได้รับการอนุมัติจากหัวหน้างาน ทั้งนี้มีผลตั้งแต่วันที่ 1 กุมภาพันธ์ 2025 เป็นต้นไป",
    contentEn: "The company announces a new Work from Home policy for 2025. Employees may work remotely up to 2 days per week with supervisor approval. This policy takes effect from February 1, 2025.",
    category: "policy",
    isPinned: true,
  ...
  {
    id: "b2",
    titleTh: "กิจกรรม Company Outing ประจำปี 2025",
    titleEn: "Annual Company Outing 2025",
    contentTh: "ขอเชิญพนักงานทุกท่านเข้าร่วมกิจกรรม Company Outing ประจำปี 2025 ณ พัทยา จังหวัดชลบุรี ในวันที่ 15-16 มีนาคม 2025 กรุณาลงทะเบียนภายในวันที่ 28 กุมภาพันธ์ 2025",
    contentEn: "All employees are invited to join the Annual Company Outing 2025 at Pattaya, Chonburi on March 15-16, 2025. Please register by February 28, 2025.",
    category: "event",
  ...
  {
    id: "b3",
    titleTh: "การอัปเดตระบบ IT และการบำรุงรักษาประจำเดือน",
    titleEn: "Monthly IT System Maintenance",
    contentTh: "แจ้งให้ทราบว่าจะมีการบำรุงรักษาระบบ IT ในวันเสาร์ที่ 25 มกราคม 2025 เวลา 22:00 - 02:00 น. ระบบอาจใช้งานไม่ได้ชั่วคราว ขออภัยในความไม่สะดวก",
    contentEn: "Please be informed that IT system maintenance will be conducted on Saturday, January 25, 2025, from 22:00 to 02:00. Systems may be temporarily unavailable. We apologize for any inconvenience.",
    category: "it",
    isPinned: false,
    postedBy: "IT Department",
    postedAt: "2025-01-18T14:00:00Z",
  },
  {
    id: "b4",
    titleTh: "ประกาศผลการประเมินพนักงานดีเด่น ประจำไตรมาส 4/2024",
    titleEn: "Q4/2024 Outstanding Employee Award Results",
    contentTh: "ขอแสดงความยินดีกับพนักงานดีเด่นประจำไตรมาส 4/2024 ได้แก่ คุณสมหมาย ใจดี แผนก Sales และคุณนภา สุขใจ แผนก Marketing ขอให้เป็นแบบอย่างที่ดีต่อไป",
    contentEn: "Congratulations to Q4/2024 Outstanding Employees: Mr. Sommai Jaidee from Sales and Ms. Napa Sukjai from Marketing. Keep up the excellent work!",
    category: "hr",
    isPinned: false,
    postedBy: "HR Department",
  ...
  {
    id: "b5",
    titleTh: "อบรมความปลอดภัยในการทำงาน ประจำปี 2025",
    titleEn: "Annual Workplace Safety Training 2025",
    contentTh: "บริษัทจัดอบรมความปลอดภัยในการทำงานประจำปี 2025 ในวันที่ 5 กุมภาพันธ์ 2025 เวลา 09:00-16:00 น. ห้องประชุมใหญ่ ชั้น 5 พนักงานทุกท่านต้องเข้าร่วม",
    contentEn: "The company will conduct Annual Workplace Safety Training 2025 on February 5, 2025 from 09:00-16:00 at the Main Conference Room, 5th Floor. All employees are required to attend.",
    category: "safety",
    isPinned: false,
    postedBy: "Safety Officer",
...
export function getBulletinPosts(): BulletinPost[] {
  if (typeof window === "undefined") return DEFAULT_BULLETIN_POSTS;
  try {
    const stored = localStorage.getItem(BULLETIN_STORAGE_KEY);
    if (stored) return JSON.parse(stored) as BulletinPost[];
  } catch {
    // ignore
  }
  return DEFAULT_BULLETIN_POSTS;
}

export function saveBulletinPosts(posts: BulletinPost[]): void {
...
export const DEMOGRAPHIC_FIELDS_REGISTRY = [
  { key: "gender",       labelTh: "เพศ",                          labelEn: "Gender",            icon: "VenetianMask",  masterOptions: GENDERS },
  { key: "ageRange",     labelTh: "ช่วงอายุตัว (Generation Gap)",  labelEn: "Generation Gap",    icon: "CalendarDays",  masterOptions: AGE_RANGES },
  { key: "tenure",       labelTh: "อายุงาน",                      labelEn: "Tenure",            icon: "Hash",          masterOptions: TENURE },
  { key: "location",     labelTh: "Site",                          labelEn: "Site",              icon: "MapPin",        masterOptions: LOCATIONS },
  { key: "businessUnit", labelTh: "หน่วยงานสังกัด",               labelEn: "Business Unit",     icon: "Building2",     masterOptions: BUSINESS_UNITS },
  { key: "department",   labelTh: "ฝ่าย",                          labelEn: "Department",        icon: "Building2",     masterOptions: DEPARTMENTS },
  { key: "level",        labelTh: "ระดับปฏิบัติการ",               labelEn: "Operational Level", icon: "Users",         masterOptions: LEVELS },
] as const;
...
export interface Question {
  ...
  updatedBy?: string;   // display name of last editor
...
export const QUESTION_BANK: SurveySection[] = [
  {
    ...
    questions: [
      { id: "A1", type: "rating", textEn: "I receive fair compensation for my work.", textTh: "ฉันได้รับค่าตอบแทนที่เหมาะสมกับงาน", required: true, minValue: 1, maxValue: 6, category: "Compensation" },
      { id: "A2", type: "rating", textEn: "Company benefits meet my needs.", textTh: "สวัสดิการของบริษัทตอบสนองความต้องการของฉัน", required: true, minValue: 1, maxValue: 6, category: "Benefits" },
      { id: "A3", type: "rating", textEn: "The organization communicates policies clearly.", textTh: "องค์กรสื่อสารนโยบายอย่างชัดเจน", required: true, minValue: 1, maxValue: 6, category: "Leadership" },
      { id: "A4", type: "rating", textEn: "I have the tools and equipment needed to perform effectively.", textTh: "ฉันมีเครื่องมืออุปกรณ์เพียงพอต่อการทำงาน", required: true, minValue: 1, maxValue: 6, category: "Tools" },
      { id: "A5", type: "rating", textEn: "The company provides stable career opportunities.", textTh: "บริษัทมอบโอกาสในการเติบโตในสายอาชีพอย่างมั่นคง", required: true, minValue: 1, maxValue: 6, category: "Growth" },
      { id: "A6", type: "rating", textEn: "I trust the management direction of the organization.", textTh: "ฉันเชื่อมั่นในทิศทางการบริหารขององค์กร", required: true, minValue: 1, maxValue: 6, category: "Leadership" },
      {
        id: "A7",
        type: "nps",
  ...
  },
  {
    ...
    questions: [
      { id: "B1", type: "rating", textEn: "My job responsibilities are clearly defined.", textTh: "ความรับผิดชอบในงานของฉันมีความชัดเจน", required: true, minValue: 1, maxValue: 6, category: "Role Clarity" },
      { id: "B2", type: "rating", textEn: "I feel proud of the work I do.", textTh: "ฉันรู้สึกภูมิใจในงานที่ทำ", required: true, minValue: 1, maxValue: 6, category: "Growth" },
      { id: "B3", type: "rating", textEn: "My supervisor supports my development.", textTh: "หัวหน้าของฉันสนับสนุนการพัฒนาของฉัน", required: true, minValue: 1, maxValue: 6, category: "Growth" },
      { id: "B4", type: "rating", textEn: "I receive constructive feedback regularly.", textTh: "ฉันได้รับข้อเสนอแนะที่สร้างสรรค์อย่างสม่ำเสมอ", required: true, minValue: 1, maxValue: 6, category: "Growth" },
      { id: "B5", type: "rating", textEn: "I have opportunities to learn and grow.", textTh: "ฉันมีโอกาสในการเรียนรู้และเติบโต", required: true, minValue: 1, maxValue: 6, category: "Growth" },
      { id: "B6", type: "rating", textEn: "My workload is manageable.", textTh: "ปริมาณงานของฉันอยู่ในระดับที่จัดการได้", required: true, minValue: 1, maxValue: 6, category: "Well-being" },
    ],
  },
  {
    id: "C",
    ...
    questions: [
      { id: "C1", type: "rating", textEn: "My workplace environment is safe.", textTh: "สภาพแวดล้อมในที่ทำงานของฉันมีความปลอดภัย", required: true, minValue: 1, maxValue: 6, category: "Environment" },
      { id: "C2", type: "rating", textEn: "Team collaboration is effective.", textTh: "การทำงานร่วมกันในทีมมีประสิทธิภาพ", required: true, minValue: 1, maxValue: 6, category: "Collaboration" },
      { id: "C3", type: "rating", textEn: "Communication within my team is good.", textTh: "การสื่อสารภายในทีมของฉันเป็นไปด้วยดี", required: true, minValue: 1, maxValue: 6, category: "Collaboration" },
      { id: "C4", type: "rating", textEn: "I feel respected by colleagues.", textTh: "ฉันรู้สึกได้รับความเคารพจากเพื่อนร่วมงาน", required: true, minValue: 1, maxValue: 6, category: "Environment" },
      { id: "C5", type: "rating", textEn: "The organization promotes work-life balance.", textTh: "องค์กรส่งเสริมความสมดุลระหว่างงานและชีวิตส่วนตัว", required: true, minValue: 1, maxValue: 6, category: "Well-being" },
      { id: "C6", type: "rating", textEn: "I feel psychologically safe expressing opinions.", textTh: "ฉันรู้สึกปลอดภัยที่จะแสดงความคิดเห็น", required: true, minValue: 1, maxValue: 6, category: "Environment" },
      {
        id: "C7",
        type: "matrix",
        textEn: "Rate your satisfaction across these areas.",
        textTh: "ประเมินความพึงพอใจของคุณในด้านต่างๆ",
        descEn: "Rate each area on a scale of 1-6",
        descTh: "ให้คะแนนแต่ละด้านในระดับ 1-6",
        required: true,
        rows: [
