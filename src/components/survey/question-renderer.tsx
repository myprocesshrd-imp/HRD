      ...
      return (
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-4">
              ...
              {nums.map((n) => {
                ...
                return (
                  <Label
                    key={n}
                    className={cn(
                      "flex flex-col items-center gap-1.5 rounded-xl border-2 p-3 sm:p-4 cursor-pointer transition-all duration-300 text-center relative overflow-hidden group",
                      selected
                  ...
                  >
                    ...
                    <span className={cn(
                      "text-[8px] font-bold uppercase tracking-wider leading-tight line-clamp-1 transition-colors duration-300",
            ...
            <div className="flex justify-between px-2 text-[9px] font-bold uppercase tracking-widest text-slate-400 italic">
            ...
            {choices.map((c) => {
              ...
              return (
                <Label
                  key={c.value}
                  className={cn(
                    "flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all duration-300 relative group",
                    selected
